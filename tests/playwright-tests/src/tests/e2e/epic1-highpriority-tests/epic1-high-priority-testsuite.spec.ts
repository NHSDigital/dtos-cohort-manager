...
test('@DTOSS-3648-01 @regression @e2e @epic1-high-priority Verify file upload into participants table for ADD', async ({ request, testData }) => {
...
testWithAmended('@DTOSS-3217-01 @regression @e2e @epic1-high-priority @Verify AMENDED records reach the participant tables', async ({ request, testData }) => {
...
test('@DTOSS-7584-01 @DTOSS-3661-01 @regression @e2e @epic1-high-priority Confirm NHS Number Count Integrity Across Participant Tables After Processing for ADD record', async ({ request, testData }) => {
  await test.step(`Given database does not contain 2 ADD records that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
testWithAmended('@DTOSS-7584-02 @DTOSS-3661-02 @regression @e2e @epic1-high-priority Confirm NHS Number Count Integrity Across Participant Tables After Processing for AMENDED record', async ({ request, testData }) => {
  await test.step(`Given database does not contain 2 ADD records that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
test('@DTOSS-3662-01 @regression @e2e @epic1-high-priority Verify ADD records that trigger a non-fatal validation rule reach internal participant tables but not Cohort distribution', async ({ request, testData }) => {
  await test.step(`Given database does not contain 2 ADD records that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
testWithAmended('@DTOSS-3662-02 @regression @e2e @epic1-high-priority Verify AMENDED records with non-fatal validation issues reach participant tables with partial Cohort distribution entries', async ({ request, testData }) => {
...
testWithAmended('@DTOSS-3217-02 @regression @e2e @epic1-high-priority Verify AMENDED records is processed without any Exception', async ({ request, testData }) => {
  await test.step(`Given database does not contain 1 ADD record that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
test('@DTOSS-3197-01 @regression @e2e @epic1-high-priority Verify ADD records is processed without any Exception', async ({ request, testData }) => {
  await test.step(`Given database does not contain 2 ADD records that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
test('@DTOSS-3744-01 @regression @e2e @epic1-high-priority Verify a file is uploaded to storage successfully', async ({ request, testData }) => {
  await test.step(`Given database does not contain 2 ADD records that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
test('@DTOSS-3192-01 @regression @e2e @epic1-high-priority Verify that a file with an invalid name creates a validation exception', async ({ request, testData }) => {
  await test.step(`Given database does not contain 1 ADD record that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
...
test('@DTOSS-3660-01 @regression @e2e @epic1-high-priority Verify Successful Data Processing and Storage in Cohort Manager for Add', async ({ request, testData }) => {
  await test.step(`Given database does not contain 1 ADD record that will be processed`, async () => {
    await cleanupDatabaseFromAPI(request, testData.nhsNumbers);
  });
