...
export const runnerBasedEpic2TestScenariosAdd = "@DTOSS-5104-01|@DTOSS-5613-01|@DTOSS-4395-01|@DTOSS-4397-01|@DTOSS-4562-01|@DTOSS-4563-01|@DTOSS-3206-01|@DTOSS-4136-01|@DTOSS-4323-01|@DTOSS-4321-01|@DTOSS-4338-01|@DTOSS-4342-01|@DTOSS-4345-01|@DTOSS-4558-01";

// export const runnerBasedEpic2TestScenariosAmend = "@DTOSS-5605-01|@DTOSS-4396-01|@DTOSS-5419-01|@DTOSS-4068-01|@DTOSS-4070-01|@DTOSS-4564-01|@DTOSS-4322-01|@DTOSS-4324-01|@DTOSS-4341-01|@DTOSS-4344-01|@DTOSS-4343-01|@DTOSS-4416-01";

export const runnerBasedEpic2TestScenariosAmend = "@DTOSS-4416-01";
