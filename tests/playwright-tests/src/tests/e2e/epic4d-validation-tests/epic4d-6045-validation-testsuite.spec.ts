...
test.describe('@regression @e2e @epic4d-validation-tests Tests', () => {
  ...
  //   await test.step(`Given ADD participants are processed to cohort`, async () => {
  ...
  // test('@DTOSS-9494-01 - Verify that exception is raised if one or more conditions are FALSE (CP - Not English - WGA, PCPC - NOT NULL - ZZZ123) - AC02 - ADD', {
  //   annotation: {
  //     type: 'Requirement',
  //     description: 'Tests - https://nhsd-jira.digital.nhs.uk/browse/DTOSS-6045',
  //   },
  ...
  //   testWithAmended('@DTOSS-9495-01 - Verify that exception is raised if one or more conditions are FALSE (CP - English - BAA, PCPC - NOT NULL - E85121) - AC02- AMENDED', {
  //     annotation: {
  //       type: 'Requirement',
  //       description: 'Tests - https://nhsd-jira.digital.nhs.uk/browse/DTOSS-6045',
  //     },
...
//       await test.step(`Then validate database tables`, async () => {
//         await validateSqlDatabaseFromAPI(request, testData.checkInDatabase);
//       });
//     });
//   });
  ...
  // test('@DTOSS-9498-01 - Verify that exception is raised if one or more conditions are FALSE (CP - NOT English, PCPC - NOT NULL) - AC02 - ADD', {
  //   annotation: {
  //     type: 'Requirement',
  //     description: 'Tests - https://nhsd-jira.digital.nhs.uk/browse/DTOSS-6045',
  //   },
  ...
  // testWithAmended('@DTOSS-9499-01 - Verify that exception is raised if one or more conditions are FALSE (CP - English, PCPC - ZZZ or NULL) - AC02 - AMENDED', {
  //   annotation: {
  //     type: 'Requirement',
  //     description: 'Tests - https://nhsd-jira.digital.nhs.uk/browse/DTOSS-6045',
  //   },
