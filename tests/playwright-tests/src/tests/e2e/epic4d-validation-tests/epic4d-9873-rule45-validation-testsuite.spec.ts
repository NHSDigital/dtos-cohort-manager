...
test.describe.serial(' @e2e @epic4d-validation-tests validate rule 45', async () => {
    test('@DTOSS-10355 - @TC1_SIT Verify that record with an ENG current posting and an invalid GP Practice code triggers rule 45', async ({ request }, testInfo) => {
    ...
    test('@DTOSS-10356 - @TC1_SIT Verify that record with an IM current posting and an invalid GP Practice code triggers rule 45', async ({ request }, testInfo) => {
        const [checkInDatabase, inputParticipantRecord, nhsNumbers, testFilesPath] = await getApiTestData(testInfo.title);
    ...
    test('@DTOSS-10357 - @TC1_SIT Verify that record with a DMS current posting and an invalid GP Practice code triggers rule 45', async ({ request }, testInfo) => {
        const [checkInDatabase, inputParticipantRecord, nhsNumbers, testFilesPath] = await getApiTestData(testInfo.title);
    ...
    test('@DTOSS-10358-01 200 - @TC1_SIT Verify that a record with an ENG current posting and a valid GP Practice code does not trigger rule 45', async ({ request }, testInfo) => {
        const [checkInDatabase, inputParticipantRecord, nhsNumbers, testFilesPath] = await getApiTestData(testInfo.title);
    ...
    test('@DTOSS-10358-01 200 - @TC1_SIT Verify that a record with a DMS current posting and an excluded GP Practice code does not trigger rule 45', async ({ request }, testInfo) => {
        const [checkInDatabase, inputParticipantRecord, nhsNumbers, testFilesPath] = await getApiTestData(testInfo.title);
    ...
    test('@DTOSS-10358-01 200 - @TC1_SIT Verify that a record where 2 or more conditions are not met does not trigger rule 45', async ({ request }, testInfo) => {
        const [checkInDatabase, inputParticipantRecord, nhsNumbers, testFilesPath] = await getApiTestData(testInfo.title);
