...
[TestClass]
public class UnblockParticipantTests
{
    ...
    private readonly Mock<ILogger<UnblockParticipant>> _loggerMock = new();
    private readonly Mock<ICreateResponse> _createResponseMock = new();
    private readonly Mock<IExceptionHandler> _exceptionHandler = new();
    private readonly SetupRequest _setupRequest = new();
    private readonly UnblockParticipant _sut;

    public UnblockParticipantTests()
    {
        ...
        _sut = new UnblockParticipant(_dsMockParticipantManagement.Object, _dsMockParticipantDemographic.Object, _loggerMock.Object, _createResponseMock.Object, _exceptionHandler.Object);
    }
