...
public class ProcessNemsUpdateTests
{
    ...
    public ProcessNemsUpdateTests()
    {
        ...
        {
            RetrievePdsDemographic = "RetrievePdsDemographic"
        };
    ...
    // Run_NemsUpdateMatchesPdsRecord_ProcessesPdsRecord
    // Run_NemsUpdateDoesNotMatchPdsRecord_ProcessesSupersededRecordAndUnsubscribesFromNems

    // Run_FailsToRetrieveNhsNumberFromNemsUpdateFile_LogsError

    // RetrievePdsDemographic returns other status codes not OK

    [TestMethod]
    public async Task Run_FailsToRetrieveNhsNumberFromNemsUpdateFile_LogsError()
    {
        // Arrange
        string fhirJson = LoadTestJson("complete-patient");
    ...
    public async Task Run_RetrievePdsRecordReturnsNonSuccessStatus_LogsError()
    {
        ...
        // also will log error in main catch block
    }
