...
public class AddNewParticipantTestClass
{
    ...
    public async Task Run_Should_log_Participant_Created()
    {
        ...
        _createParticipant.Setup(x => x.CreateResponseParticipantModel(basicParticipantCsvRecord.Participant,Demographic)).Returns(participantCsvRecord.Participant);
