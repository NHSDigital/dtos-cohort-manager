locals {
  fnapp_urls = {
    ...
    retrieveCohortRequestAudit       = "https://${var.names.function-app}-${lower(var.function_app.RetrieveCohortRequestAudit.name_suffix)}.azurewebsites.net/api/RetrieveCohortRequestAudit"
  }
