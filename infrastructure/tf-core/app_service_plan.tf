...
module "app-service-plan" {
  ...
  vnet_integration_subnet_id                        = var.app_service_plan.vnet_integration_enabled ? module.subnets["${module.regions_config[each.value.region].names.subnet}-apps"].id : null
