locals {
  # APPSERVICEPLAN
  monitor_diagnostic_setting_appserviceplan_enabled_metrics = ["AllMetrics"]

  # FUNCTIONAPP
  monitor_diagnostic_setting_function_app_enabled_logs    = ["AppServiceAuthenticationLogs", "FunctionAppLogs"]
  monitor_diagnostic_setting_function_app_enabled_metrics = ["AllMetrics"]

  # KEYVAULT
  monitor_diagnostic_setting_keyvault_enabled_logs    = ["AuditEvent", "AzurePolicyEvaluationDetails"]
  monitor_diagnostic_setting_keyvault_enabled_metrics = ["AllMetrics"]

  # LOG ANALYTICS WORKSPACE
  monitor_diagnostic_setting_log_analytics_workspace_enabled_logs    = ["SummaryLogs", "Audit"]
  monitor_diagnostic_setting_log_analytics_workspace_enabled_metrics = ["AllMetrics"]
  ...
  monitor_diagnostic_setting_database_enabled_metrics   = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]
  monitor_diagnostic_setting_sql_server_enabled_logs    = ["SQLSecurityAuditEvents"]
  monitor_diagnostic_setting_sql_server_enabled_metrics = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]

  # STORAGE ACCOUNT
  monitor_diagnostic_setting_storage_account_enabled_logs    = ["StorageWrite", "StorageRead", "StorageDelete"]
  monitor_diagnostic_setting_storage_account_enabled_metrics = ["Capacity", "Transaction"]
  ...
  monitor_diagnostic_setting_vnet_enabled_metrics = ["AllMetrics"]

  # WEB APP
  monitor_diagnostic_setting_linux_web_app_enabled_logs    = ["AppServicePlatformLogs"]
  monitor_diagnostic_setting_linux_web_app_enabled_metrics = ["AllMetrics"]
}
