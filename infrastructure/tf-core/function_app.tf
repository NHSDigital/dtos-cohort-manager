module "functionapp" {
  ...
  app_service_logs_retention_period_days = var.app_service_logs.logs_retention_period_days
  app_service_logs_disk_quota_mb         = var.app_service_logs.disk_quota_mb
