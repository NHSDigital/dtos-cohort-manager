module "azure_sql_server" {
  ...
  monitor_diagnostic_setting_database_enabled_metrics   = local.monitor_diagnostic_setting_database_enabled_metrics
  monitor_diagnostic_setting_sql_server_enabled_logs    = local.monitor_diagnostic_setting_sql_server_enabled_logs
  monitor_diagnostic_setting_sql_server_enabled_metrics = local.monitor_diagnostic_setting_sql_server_enabled_metrics
