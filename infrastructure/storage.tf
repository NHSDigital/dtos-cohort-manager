module "storage" {
  ...
  resource_group_name = module.baseline.resource_group_names[var.storage_accounts.fnapp.resource_group_index]
  location            = module.baseline.resource_group_locations[var.storage_accounts.fnapp.resource_group_index]
