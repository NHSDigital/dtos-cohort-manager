...
BEGIN
    ...
    (
        ...
        PRIMARY_CARE_PROVIDER VARCHAR(10) NULL,
        PRIMARY_CARE_PROVIDER_FROM_DT VARCHAR(10) NULL,
        CURRENT_POSTING VARCHAR(10) NULL,
        CURRENT_POSTING_FROM_DT VARCHAR(10) NULL,
        NAME_PREFIX VARCHAR(10) NULL,
        GIVEN_NAME VARCHAR(100) NULL,
        OTHER_GIVEN_NAME VARCHAR(100) NULL,
        FAMILY_NAME VARCHAR(100) NULL,
        ...
        USUAL_ADDRESS_FROM_DT VARCHAR(10) NULL,
        DATE_OF_DEATH VARCHAR(10) NULL,
        DEATH_STATUS SMALLINT NULL,
        TELEPHONE_NUMBER_HOME VARCHAR(35) NULL,
        TELEPHONE_NUMBER_HOME_FROM_DT VARCHAR(10) NULL,
        TELEPHONE_NUMBER_MOB VARCHAR(35) NULL,
        TELEPHONE_NUMBER_MOB_FROM_DT VARCHAR(10) NULL,
        EMAIL_ADDRESS_HOME VARCHAR(100) NULL,
        EMAIL_ADDRESS_HOME_FROM_DT VARCHAR(10) NULL,
        PREFERRED_LANGUAGE VARCHAR(35) NULL,
        INTERPRETER_REQUIRED SMALLINT NULL,
...
BEGIN
    ...
    (
        ...
        CONSTRAINT PK_HIGHER_RISK_REFERRAL_REASON
            PRIMARY KEY (HIGHER_RISK_REFERRAL_REASON_ID)
    );
END
...
BEGIN
    ...
    (
        ...
        CONSTRAINT PK_GENE_CODE_LKP
            PRIMARY KEY (GENE_CODE_ID)
    );
END
