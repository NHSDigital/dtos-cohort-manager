...
/*==============================================================*/
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'CONTACT_PREFERENCE')
BEGIN
...
/* Table: GENDER_MASTER                                         */
/*==============================================================*/
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'GENDER_MASTER')
BEGIN
...
/* Table: PARTICIPANT                                           */
/*==============================================================*/
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'PARTICIPANT')
BEGIN
...
/*==============================================================*/
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_ADDRESS_PARTICIPANT'
...
IF NOT EXISTS ( SELECT * FROM sys.foreign_keys WHERE name = 'FK_CONTACT_PARTICIPANT'
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PARTICIPANT_COHORT'
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PARTICIPANT_GENDER_FK_GENDER_M'
AND parent_object_id = OBJECT_ID('dbo.PARTICIPANT'))
BEGIN
ALTER TABLE dbo.PARTICIPANT
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_COHORT_PROGRAM_FK_PROGRAM'
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PARTICIP_SCREENING_SCREENIN'
