...
BEGIN
    ...
    (
        ...
        SERVICENOW_ID NVARCHAR(50) NULL,
...
(
    ...
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_SCHEMA = 'dbo'
          AND TABLE_NAME = 'NEMS_SUBSCRIPTION'
)
BEGIN
    ...
    (
        ...
        CONSTRAINT PK_NEMS_SUBSCRIPTION
            PRIMARY KEY (SUBSCRIPTION_ID)
    );
END

CREATE INDEX [Index_NEMS_SUBSCRIPTION_NhsNumber] ON [dbo].[NEMS_SUBSCRIPTION] ([NHS_NUMBER]);
...
(
    ...
    FROM INFORMATION_SCHEMA.TABLES
    WHERE TABLE_SCHEMA = 'dbo'
          AND TABLE_NAME = 'SERVICENOW_CASES'
)
BEGIN
CREATE TABLE [dbo].[SERVICENOW_CASES]
    (
      SERVICENOW_ID VARCHAR(10) NOT NULL,
      NHS_NUMBER BIGINT NULL,
