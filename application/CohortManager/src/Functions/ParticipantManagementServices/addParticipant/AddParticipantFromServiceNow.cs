...
public class AddParticipantFromServiceNow
{
    private readonly ILogger<AddParticipantFromServiceNow> _logger;
    private readonly AddParticipantConfig _config;
    private readonly IHttpClientFunction _httpClientFunction;
    private readonly IExceptionHandler _handleException;

    public AddParticipantFromServiceNow(ILogger<AddParticipantFromServiceNow> logger, IOptions<AddParticipantConfig> addParticipantConfig,
    ...
    [Function(nameof(AddParticipantFromServiceNow))]
