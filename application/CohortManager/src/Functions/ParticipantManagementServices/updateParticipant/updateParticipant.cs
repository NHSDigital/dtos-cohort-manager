...
public class UpdateParticipantFunction
{
    ...
    {
        if (!await _cohortDistributionHandler.SendToCohortDistributionService(participant.NhsNumber, participant.ScreeningId, participant.RecordType, participant.CurrentPosting, fileName))
        {
