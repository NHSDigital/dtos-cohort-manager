            ...
            modelBuilder.Entity("Model.ParticipantAuditLog", b =>
                {
                    ...
                    b.HasIndex(new[] { "BatchId", "CreatedDatetime" }, "IX_AUDIT_BATCH")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "CorrelationId" }, "IX_AUDIT_CORRELATION");

                    b.HasIndex(new[] { "NhsNumber", "CreatedDatetime" }, "IX_AUDIT_NHS_NUMBER")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "RecordSource", "CreatedDatetime" }, "IX_AUDIT_SOURCE")
                        .IsDescending(false, true);
