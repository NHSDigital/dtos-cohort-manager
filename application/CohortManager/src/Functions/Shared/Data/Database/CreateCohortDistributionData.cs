...
public class CreateCohortDistributionData : ICreateCohortDistributionData
{
    ...
    public bool InsertCohortDistributionData(CohortDistributionParticipant cohortDistributionParticipant)
    {
        ...
        var parameters = new Dictionary<string, object>
        {
            ...
            {"@dateOfBirth", _databaseHelper.ConvertNullToDbNull(cohortDistributionParticipant.DateOfBirth)},
            ...
            {"@dateOfDeath", _databaseHelper.ConvertNullToDbNull(cohortDistributionParticipant.DateOfDeath)},
