...
public class CreateCohortDistributionData : ICreateCohortDistributionData
{
    ...
    private static List<CohortDistributionParticipantDto> CohortDistributionParticipantDto(List<CohortDistributionParticipant> listOfAllParticipants, string requestId)
    {
        return listOfAllParticipants.Select(s => new CohortDistributionParticipantDto
        {
            ...
            PrimaryCareProviderEffectiveFromDate = DatabaseHelper.FormatDateAPI(s.PrimaryCareProviderEffectiveFromDate) ?? string.Empty,
            ...
            DateOfBirth = DatabaseHelper.FormatDateAPI(s.DateOfBirth) ?? string.Empty,
            ...
            UsualAddressEffectiveFromDate = DatabaseHelper.FormatDateAPI(s.UsualAddressEffectiveFromDate) ?? string.Empty,
            DateOfDeath = DatabaseHelper.FormatDateAPI(s.DateOfDeath) ?? string.Empty,
            TelephoneNumber = s.TelephoneNumber ?? string.Empty,
            TelephoneNumberEffectiveFromDate = DatabaseHelper.FormatDateAPI(s.TelephoneNumberEffectiveFromDate) ?? string.Empty,
            ...
            ReasonForRemovalEffectiveFromDate = DatabaseHelper.FormatDateAPI(s.ReasonForRemovalEffectiveFromDate) ?? string.Empty,
