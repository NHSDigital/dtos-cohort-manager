...
public interface IValidationExceptionData
{
    ...
    Task<List<ValidationException>> GetFilteredExceptions(ExceptionStatus? exceptionStatus, SortOrder? sortOrder, ExceptionCategory exceptionCategory, SortBy? sortBy = null, int? ruleId = null, DateTime? dateCreated = null);
    ...
    Task<ValidationExceptionsResponse> GetExceptionsByNhsNumber(string nhsNumber);
}
