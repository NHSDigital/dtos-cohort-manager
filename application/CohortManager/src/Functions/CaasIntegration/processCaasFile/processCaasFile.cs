            ...
            switch (participant.RecordType?.Trim())
            {
                case Actions.New:
                    ...
                    try
                    {
                        ...
                        {
                            _azureQueueStorageHelper.AddItemsToQueueAsync("add-participant-queue", Environment.GetEnvironmentVariable("FUNCTIONS_WORKER_RUNTIME"), basicParticipantCsvRecord);
