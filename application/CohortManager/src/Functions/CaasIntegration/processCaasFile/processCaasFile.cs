            ...
            switch (participant.RecordType?.Trim())
            {
                case Actions.New:
                    ...
                    try
                    {
                        ...
                        {
                            await _azureQueueStorageHelper.AddItemsToQueueAsync("add-participant-queue", Environment.GetEnvironmentVariable("AzureWebJobsStorage"), basicParticipantCsvRecord);
