...
curl -X POST "https://your-apim-instance.azure-api.net/api/CreateException" \
...
curl -X GET "https://your-apim-instance.azure-api.net/api/CreateException" \
  -H "Content-Type: application/json" \
  -H "Ocp-Apim-Subscription-Key: your-key-here" \
  -d @exception.json

# Include response headers
curl -i -X POST "https://your-apim-instance.azure-api.net/api/CreateException" \
  -H "Content-Type: application/json" \
  -H "Ocp-Apim-Subscription-Key: your-key-here" \
  -d @exception.json
```
...
curl -X PUT "https://your-apim-instance.azure-api.net/api/UpdateException" \
  -H "Content-Type: application/json" \
  -H "Ocp-Apim-Subscription-Key: your-key-here" \
  -d '{
    "exceptionId": "123",
...
curl -i -X PUT "https://your-apim-instance.azure-api.net/api/UpdateException" \
  -H "Content-Type: application/json" \
  -H "Ocp-Apim-Subscription-Key: your-key-here" \
  -d '{
    "exceptionId": "456",
...
### CreateException (HTTP Endpoint)
- Exceptions created per hour
- HTTP success rate (200 vs 500)
- Exception category distribution
- Fatal vs non-fatal ratio
- Average response time

### RunCreateException (Service Bus)
...
- Updates per hour
- Update success rate
- 204 No Content rate (not found)
- ServiceNow integration lag time
- Average time from exception creation to ServiceNow update
