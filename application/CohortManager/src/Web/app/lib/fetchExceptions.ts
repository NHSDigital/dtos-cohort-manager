...
export async function fetchExceptions(params: FetchExceptionsParams = {}) {
  ...
  if (params.exceptionId) query.append("exceptionId", params.exceptionId.toString());
  if (params.page) query.append("page", params.page.toString());
  if (params.lastId) query.append("lastId", params.lastId.toString());
  if (params.exceptionStatus !== undefined) query.append("exceptionStatus", params.exceptionStatus.toString());
  if (params.sortOrder) query.append("sortOrder", params.sortOrder.toString());
  if (params.exceptionCategory) query.append("exceptionCategory", params.exceptionCategory);
  if (params.reportDate) query.append("reportDate", params.reportDate);
  if (params.isReport !== undefined) query.append("isReport", params.isReport.toString());
